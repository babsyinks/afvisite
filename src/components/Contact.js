    ...
    <div id='contact'>
      ...
      <div id='contactgroup'>
        <div className='contactoptions'>
          ...
          <div className='contact_medium'><a className='phn' href='tel:09028614120'><span>Click to call us on this number: 09028614120</span></a> </div>
        </div>
        <div className='contactoptions'>
        <div><i className ="fa-solid fa-envelope fa-5x envelope"></i></div>
          ...
          <div className='contact_medium'><a className='env' href='mailto:afvi@abujafilmvillage.com'><span>Click to mail us on: <div className='wordBreak'>afvi@abujafilmvillage.com</div></span></a></div>
        </div>
        <div className='contactoptions'>
